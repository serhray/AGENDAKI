    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-sm md:text-base">Gerencie os serviços oferecidos</p>
        </div>
        <button
          onClick={() => openModal()}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-6">
          <p className="text-xs md:text-sm text-gray-400 mb-1">Total de Serviços</p>
          <p className="text-2xl md:text-3xl font-bold text-indigo-400">{services.length}</p>
        </div>
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-6">
          <p className="text-xs md:text-sm text-gray-400 mb-1">Serviços Ativos</p>
          <p className="text-2xl md:text-3xl font-bold text-green-400">
            {services.filter((s) => s.active).length}
          </p>
        </div>
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-6">
          <p className="text-xs md:text-sm text-gray-400 mb-1">Ticket Médio</p>
          <p className="text-2xl md:text-3xl font-bold text-yellow-400">
            R$ {services.length > 0 ? (totalRevenue / services.length).toFixed(2) : "0.00"}
          </p>
        </div>
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-6">
          <p className="text-xs md:text-sm text-gray-400 mb-1">Receita Potencial</p>
